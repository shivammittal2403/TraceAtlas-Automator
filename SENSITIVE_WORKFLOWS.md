...
TraceAtlas 0.4 automates five sensitive research categories inside a deliberately
...
|---|---|---|---|---|
| Dark-web research | `darkweb-monitor` | Approved index export, or permitted Ahmia clear-web search | Title/onion service SHA-256, title length, target-mention flag | Raw title, Tor connection, onion fetch, page content, marketplace interaction |

...
CAPABILITIES: dict[str, CapabilitySpec] = {spec.id: spec for spec in (
    ...
    _s("misp", "MISP Threat Sharing", "github.com/MISP/MISP", "AGPL-3.0", "service",
       ("indicator-search", "warning-lists", "taxonomies", "galaxies", "threat-sharing"),
       credential_env=("MISP_API_KEY",),
       safety=("authorization", "owned-org", "service-boundary", "metadata-only", "no-attachments"),
       restriction="MISP remains a separately deployed service; TraceAtlas uses bounded restSearch only."),
